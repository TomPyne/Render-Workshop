...
IMGUI_IMPL_API bool					ImGui_ImplRender_Init(rl::RenderFormat backbufferFormat);
...
IMGUI_IMPL_API void					ImGui_ImplRender_RenderDrawData(ImRenderFrameData* frame_data, ImDrawData* draw_data, rl::CommandList* cl);
...
IMGUI_IMPL_API rl::RootSignature_t	ImGui_ImplRender_GetRootSignature();